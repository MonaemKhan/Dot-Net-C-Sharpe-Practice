...
namespace InvenTrackPro.Infrastructure.Migrations
{
    ...
    [Migration("20231024165819_Create_QuanIT")]
    partial class Create_QuanIT
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.CompanyInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactPerson = "Abc",
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 24, 16, 58, 19, 59, DateTimeKind.Unspecified).AddTicks(8241), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "xyz@gmail.com",
                            Fax = "1212",
                            IsActive = true,
                            IsDelete = false,
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.Identities.IdentityModel+User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4e33b0eb-da44-47e2-8ce0-2ed0de93486d",
                            CreatedBy = 0L,
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECLxNOIQ3UTbQEThoH3cNgKlceNJkIryB+bG46UIYo1KSXHeaFNvHND1ONbjNSHfaw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1d96ad84-2cb2-466d-8e88-5909d9390801",
                        ...
                        new
                        {
                            Id = 2L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6ff7eb4b-5f8e-4dd0-a30c-ccab5b7baa41",
                            CreatedBy = 0L,
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENWhosOeLuCcDukhJsYep2rFZgQ1PX6A/M71QT4bS5uBQDR6MSjGf5RV7/2nXox/sA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7f25ecd0-66a9-4128-a28e-99068584a8ba",
                            TramsAndConditions = true,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.PurchaseMasterArchives", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 24, 16, 58, 19, 64, DateTimeKind.Unspecified).AddTicks(9484), new TimeSpan(0, 0, 0, 0, 0)),
                            EdEvents = "EVT 01",
                            IsActive = true,
                            IsDelete = false,
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.PurchaseMasterDetailsArchives", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BRID = 1,
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 24, 16, 58, 19, 67, DateTimeKind.Unspecified).AddTicks(6204), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                            IsDelete = false,
                            ItemId = 1,
                            MSLNo = "abc123",
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.PurchaseMasterDetailss", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BRID = 1,
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 24, 16, 58, 19, 69, DateTimeKind.Unspecified).AddTicks(7360), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                            IsDelete = false,
                            ItemId = 1,
                            MSLNo = "abc123",
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.QuanITs", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 24, 16, 58, 19, 70, DateTimeKind.Unspecified).AddTicks(8865), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                            IsDelete = false,
                            QunITName = "xyz"
                        });
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.RepairServices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BRId = 1,
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 24, 16, 58, 19, 73, DateTimeKind.Unspecified).AddTicks(8891), new TimeSpan(0, 0, 0, 0, 0)),
                            DollerAmount = 10.0,
                            ...
                            PartyId = 1,
                            ReceiveDate = new DateTimeOffset(new DateTime(2023, 10, 24, 22, 58, 19, 73, DateTimeKind.Unspecified).AddTicks(8896), new TimeSpan(0, 6, 0, 0, 0)),
                            RepairId = 1,
                            SRNO = "abc",
