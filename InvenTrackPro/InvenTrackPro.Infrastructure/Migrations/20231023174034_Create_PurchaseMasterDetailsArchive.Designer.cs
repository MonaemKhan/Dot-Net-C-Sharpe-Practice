...
namespace InvenTrackPro.Infrastructure.Migrations
{
    ...
    [Migration("20231023174034_Create_PurchaseMasterDetailsArchive")]
    partial class Create_PurchaseMasterDetailsArchive
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.CompanyInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactPerson = "Abc",
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 23, 17, 40, 33, 785, DateTimeKind.Unspecified).AddTicks(3711), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "xyz@gmail.com",
                            Fax = "1212",
                            IsActive = true,
                            IsDelete = false,
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.Identities.IdentityModel+User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e2922fe7-e936-4783-92da-f380395b6d58",
                            CreatedBy = 0L,
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEWu6Eq63TarnueJNHtzs17dr/peX+x2+Oj8G0BYawwmoEx+mMR/73wm+sX9EWqyHg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4a5696b7-81a0-46e3-8a51-36e623cad0c7",
                        ...
                        new
                        {
                            Id = 2L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ebc4b5b5-3bf6-4696-9004-1025e5763fa4",
                            CreatedBy = 0L,
                            CreatedDate = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJhjoVmgV7zdmobfgFaKq+EvXwBM6571ZO25Xz8V3Z5bb3JA7VxvhYahLgGxM0pGfw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "278cd1e8-c0ce-4ab7-8357-fe79571422fe",
                            TramsAndConditions = true,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.PurchaseMasterArchives", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 23, 17, 40, 33, 788, DateTimeKind.Unspecified).AddTicks(3397), new TimeSpan(0, 0, 0, 0, 0)),
                            EdEvents = "EVT 01",
                            IsActive = true,
                            IsDelete = false,
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.PurchaseMasterDetailsArchives", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BRID = 1,
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 23, 17, 40, 33, 790, DateTimeKind.Unspecified).AddTicks(3723), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                            IsDelete = false,
                            ItemId = 1,
                            MSLNo = "abc123",
            ...
            modelBuilder.Entity("InvenTrackPro.SharedKernel.Entities.PurchaseMasterDetailss", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BRID = 1,
                            CreatedBy = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2023, 10, 23, 17, 40, 33, 792, DateTimeKind.Unspecified).AddTicks(2148), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                            IsDelete = false,
                            ItemId = 1,
                            MSLNo = "abc123",
