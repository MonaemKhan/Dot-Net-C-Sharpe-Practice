...
namespace Employment.DataAccess.Migrations
{
    ...
    [Migration("20230927184701_CreateAllTable")]
            ...
            modelBuilder.Entity("Employment.Model.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 9, 28, 0, 47, 1, 575, DateTimeKind.Unspecified).AddTicks(6350), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            DepartmentName = "IT",
                            Status = 1
                        });
